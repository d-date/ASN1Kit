...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "http://github.com/Carthage/Commandant", from: "0.18.0"),
        .package(url: "https://github.com/gematik/ref-GemCommonsKit", from: "1.0.0")
    ],
    targets: [
        ...
        .executableTarget(
            name: "CLI",
            dependencies: ["ASN1Kit", .product(name: "Commandant", package: "Commandant")]),
        .testTarget(
            name: "ASN1KitTests",
